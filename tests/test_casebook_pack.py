"""Regression checks for the beacon-mesh-clock-hub casebook."""
...
from casebook.harness import assert_expected, beacon_mesh_clock_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(beacon_mesh_clock_hub_summary(), assert_expected())
